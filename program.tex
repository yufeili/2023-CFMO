...
\\  {\normalsize 18 ~Nov 2018}
 ...
 % \linespread{3.0}
    ...
    \begin{composition}{Fan Guangzhi (范光治）} {}{On the river （江上）, Excerpt}{}
      \piece{Bawu（巴乌）: Shen Han-Wei, Piano: Su Xin}             {}{}
    \end{composition}
  ...
  %  \end{composition}
    ...
    \begin{composition}{Sichun Folk Song（四川民谣）,\ Arr.\ Li Junping （黎俊平）}{}{Kangding Love Song  （康定情歌）}{}
     % \piece{Caro mio ben}             {}{}
    \end{composition}
    \begin{composition}{Gu Guanren（顾冠仁）\\ Arr. Hu Jianming （胡建明）, Hu Borui （胡柏瑞）}{}{Galloping Steeds  （骏马奔驰）}{}
     % \piece{Caro mio ben}             {}{}
    \end{composition}
    \begin{composition}{Huang Haihuai （黄海怀）\\ Arr. Chen Yanoxing （陈耀星）,\  Chen Jun （陈军）}{}{Racing Horses  （赛马）}{}
    \piece{Erhu: Li Wushuang, Tang Chenhao, Hu Chong,\\ Liu Xuyao, Piano: Su Xin}{}{}
      %\piece{Caro mio ben}             {}{}
    \end{composition}\\
...
Set Coordinator: Li Binglong (李秉隆),\\ Jiang Jianan(姜佳楠),  Liu Changyue(刘畅越),\\ Riki Wei(魏诗吉)\\
 Video editing: Li Wushuang, Chen Zheming, Lu Shiyu,\\ Gu Kevin, Liu Xuyao\\ \\
Photographer：Li Weicheng(李维城),\\ Wang Yuechen(王月辰)\\
AV Manager: Joshua E. Poston\\
Promotion：Tracy Shen, Lu Shiyu, Li Yufei, Su Xin\\
\\
