...
%\setCJKfamilyfont{hwxk}{simkai}             %使用STXingkai华文行楷字体
%\newcommand{\ch1}{\CJKfamily{hwxk}}
%\pagestyle{empty}
...
\begin{spacing}{0.85} 
\begin{center}
\Huge{C}\large{HINESE } \Huge{F}\large{OLK} \Huge{M}\large{USIC} \Huge{O}\large{RCHESTRA} \Huge{CONCERT}
\end{center}
\begin{programme}{
%%行间距
...
\\  {\normalsize 18 ~Nov 2018}
 ...
 % \linespread{3.0}
    ...
    \begin{composition}{Fan Guangzhi (范光治)} {}{On the river （江上）, Excerpt}{}
      \piece{Dizi: Shen Hanwei, Piano: Su Xin}             {}{}
    \end{composition}
     \begin{composition}{} {}{（世间）}{}
      \piece{Dizi: Xiong Tianyu, Mo Xiaoting, Bao Teng, Kevin Gu, Shen Hanwei}             {}{}
    \end{composition}    
    ...
    %  \piece{Caro mio ben}             {}{}
    \end{composition}
    \begin{composition}{Joe Hisaishi (\textbf{\mincho {久石譲})}}{}{Innocent （\bm{\mincho{君をのせて}}）, from Castle in the Sky }{}
